...
public class ApplicantRecommendation implements org.apache.thrift.TBase<ApplicantRecommendation, ApplicantRecommendation._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ApplicantRecommendation");
  ...
  private static final org.apache.thrift.protocol.TField ANNOTATION_FIELD_DESC = new org.apache.thrift.protocol.TField("annotation", org.apache.thrift.protocol.TType.I32, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ApplicantRecommendationStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ApplicantRecommendationTupleSchemeFactory());
  }

  private long applicationId; // required
  private String algorithm; // required
  private double score; // required
  private int annotation; // required
  ...
  private static final int __ANNOTATION_ISSET_ID = 2;
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ApplicantRecommendation.class, metaDataMap);
  }
    ...
    int annotation)
  {
    ...
    setAnnotationIsSet(true);
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public ApplicantRecommendation(ApplicantRecommendation other) {
  ...
  public ApplicantRecommendation deepCopy() {
    return new ApplicantRecommendation(this);
  }
  ...
  public void unsetAnnotation() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ANNOTATION_ISSET_ID);
  }

  /** Returns true if field annotation is set (has been assigned a value) and false otherwise */
  public boolean isSetAnnotation() {
    return EncodingUtils.testBit(__isset_bitfield, __ANNOTATION_ISSET_ID);
  }

  public void setAnnotationIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ANNOTATION_ISSET_ID, value);
  }
  ...
  public Object getFieldValue(_Fields field) {
    switch (field) {
    case APPLICATION_ID:
      return Long.valueOf(getApplicationId());
    ...
    case ANNOTATION:
      return Integer.valueOf(getAnnotation());
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ApplicantRecommendation)
      return this.equals((ApplicantRecommendation)that);
    return false;
  }

  public boolean equals(ApplicantRecommendation that) {
    if (that == null)
      return false;
    ...
    boolean this_present_annotation = true;
    boolean that_present_annotation = true;
    if (this_present_annotation || that_present_annotation) {
      if (!(this_present_annotation && that_present_annotation))
        return false;
      if (this.annotation != that.annotation)
        return false;
    }
  ...
  public int compareTo(ApplicantRecommendation other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    ApplicantRecommendation typedOther = (ApplicantRecommendation)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ApplicantRecommendation(");
    boolean first = true;
  ...
  private static class ApplicantRecommendationStandardSchemeFactory implements SchemeFactory {
    public ApplicantRecommendationStandardScheme getScheme() {
      return new ApplicantRecommendationStandardScheme();
    }
  }

  private static class ApplicantRecommendationStandardScheme extends StandardScheme<ApplicantRecommendation> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ApplicantRecommendation struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // ANNOTATION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.annotation = iprot.readI32();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ApplicantRecommendation struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeI32(struct.annotation);
      oprot.writeFieldEnd();
  ...
  private static class ApplicantRecommendationTupleSchemeFactory implements SchemeFactory {
    public ApplicantRecommendationTupleScheme getScheme() {
      return new ApplicantRecommendationTupleScheme();
    }
  }

  private static class ApplicantRecommendationTupleScheme extends TupleScheme<ApplicantRecommendation> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ApplicantRecommendation struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ApplicantRecommendation struct) throws org.apache.thrift.TException {
